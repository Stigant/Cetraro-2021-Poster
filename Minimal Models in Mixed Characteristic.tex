		...
		\begin{column}{0.36\paperwidth}
			...
			\begin{block}{Geography of Ample Models - Example}
				...
				\begin{center}
					...
					% Text Node
					\draw (240,185) node [anchor=south east][inner sep=2pt]  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ,xscale=1.5,yscale=1.5]  {$\mathbb{F}^{1}$};
					% Text Node
					\draw (360,185) node [anchor=south west][inner sep=2pt]  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ,xscale=1.5,yscale=1.5]  {$\mathbb{F}^{1}$};
					% Text Node
